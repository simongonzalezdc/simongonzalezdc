        # Factory intake for issue #271: [pipeline][MEDIUM] [simongonzalezdc/simongonzalezdc] Dashboard cannot fully read repository status
...
- **Generated at:** 2026-05-10T01:16:44Z
...
```json
{
  "dashboard_row": {
    ...
    "ci_name": "CI",
    "ci_status": "completed",
    "ci_timestamp": "2026-05-09T14:09:09Z",
    "errors": [
    ...
    "recent_commits": [
      {
        "date": "2026-05-09T14:09:05Z",
        "message": "fix: [pipeline][MEDIUM] [simongonzalezdc/simongonzalezdc] Dashboa (#12)",
        "sha": "1b3ecfb"
      },
      {
        "date": "2026-05-09T13:23:34Z",
        "message": "fix: Missing CHANGELOG.md (#13)",
        "sha": "d49680f"
      },
      {
